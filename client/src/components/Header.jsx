...
//           >
//             <p className="font-semibold text-lg text-blue-700 hover:text-blue-600">
//               Practice
//             </p>
//             {practiceDropdown && (
//               <div className="absolute top-8 left-0 bg-white shadow-lg p-3 rounded-md w-40 animate-fadeIn">
//                 <Link to="/practice/cpp" className="block px-3 py-2 hover:bg-gray-200 rounded">
//                   C++
//                 </Link>
//                 <Link to="/practice/java" className="block px-3 py-2 hover:bg-gray-200 rounded">
//                   Java
//                 </Link>
//                 <Link to="/practice/react" className="block px-3 py-2 hover:bg-gray-200 rounded">
//                   React
//                 </Link>
//               </div>
//             )}
...
//           {/* 📌 Resume Interview */}
//           <Link to="/resume" className="font-semibold text-lg text-blue-700 hover:text-blue-600">
//             Resume
//           </Link>
//           <Link to="/interview" className="font-semibold text-lg text-blue-700 hover:text-blue-600">
//             Interview
//           </Link>
//         </nav>
...
//                     <Link to={"/admin-panel"} className="block px-3 py-2 hover:bg-gray-200 rounded">
//                       Admin Panel
//                     </Link>
//                   )}
//                   <button
//                     onClick={handleLogout}
//                     className="block w-full text-left px-3 py-2 hover:bg-red-200 text-red-600 rounded"
//                   >
//                     Logout
//                   </button>
//                 </div>
...
//             <Link
//               to={"/login"}
//               className="bg-blue-600 text-white px-5 py-2 rounded-full hover:bg-blue-400 transition"
//             >
//               Login
//             </Link>
//           )}
      ...
      <div className="h-16 container mx-auto flex items-center px-6 justify-between">
        ...
        <nav className="flex items-center gap-8">
          ...
          <div className="relative group cursor-pointer" onMouseEnter={() => setPracticeDropdown(true)} onMouseLeave={() => setPracticeDropdown(false)}>
            ...
            {practiceDropdown && (
              <div className="absolute top-8 left-0 bg-white shadow-lg p-3 rounded-md w-40 animate-fadeIn">
                <Link to="/practice/cpp" className="block px-3 py-2 hover:bg-gray-200 rounded">C++</Link>
                <Link to="/practice/java" className="block px-3 py-2 hover:bg-gray-200 rounded">Java</Link>
                <Link to="/practice/react" className="block px-3 py-2 hover:bg-gray-200 rounded">React</Link>
              </div>
            )}
          </div>
